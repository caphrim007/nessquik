...
* @author Tim Rupp
*/
class Permissions_Policy extends Permissions_Abstract {
	...
	*/
	public function add($resource) {
		...
		try {
			...
			$db->insert('permissions_policy', $data);
			return true;
	...
	*/
	public function delete($id) {
		...
		try {
			...
			$db->delete('permissions_policy', $where);
			return true;
		} catch (Exception $error) {
			throw new Permissions_Exception($error->getMessage());
		}
	...
	*/
	public function get($resource = null, $page = 1, $limit = 15) {
		...
		$sql = $db->select()
			->from('permissions_policy', array('permission_id' => 'id', 'permission_resource' => 'resource'));
